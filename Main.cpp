...
void AMain::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//动作映射的ESC绑定 - 一次性的  - 关键词 - IE_Pressed - IE_Released - 按下/松开键
...
void AMain::LoadGame(bool SetPosition)
{
	...
	//为WeaponStroage（U类） - 创建一个实例 - 去生成一个Actor
	if (WeaponStorage)
	{
